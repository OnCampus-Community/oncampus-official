      ...
      <div className="second-wrapper">
        <div className="first-half">
          <div className="first-line">
            <div className="line">
              Igniting <p className="line-bag">BUSINESS GROWTH</p> <br />{" "}
              through campaigns.
            </div>
          </div>
          <div className="first-box">
            <div className="first-half-wrapper-bg"></div>
            <div className="first-half-wrapper">
              <div className="box-wrapper">
                <div className="box-heading">
                  <p className="box-heading-line">Our Vision</p>
                </div>
        ...
        <div className="second-half">
          ...
          <div className="second-bottom">
            ...
            <p className="image-text">Marketing</p>
          </div>
        </div>
      </div>
    </div>
